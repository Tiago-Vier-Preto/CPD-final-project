...
class Table(Page):
    ...
    def calculate_payload_size(self, values):
        ...
        self.table_desc = {"id": {"datatype": "int", "constraints": "pri:not null"},
                           "Sexo": {"datatype": "text", "constraints": "not null"},
                           "Faixa Etária": {"datatype": "int", "constraints": "not null"},
                           "Cor/Raça": {"datatype": "int", "constraints": "not null"},
                           "Situação E.M.": {"datatype": "int", "constraints": "not null"},
                           "Tipo de Escola":    {"datatype": "int", "constraints": "not null"},
                           "UF": {"datatype": "int", "constraints": "not null"},
                           "Nota Matemática": {"datatype": "int", "constraints": "not null"},
                           "Nota CN": {"datatype": "int", "constraints": "not null"},
                           "Nota Redação": {"datatype": "int", "constraints": "not null"},}
    ...
    def select_from_table(self, table_name, select_columns, cond_column=None, cond_operator=None, cond_value=None,
        ...
        for rec in range(len(all_records)):
            temp_record.append(all_records[rec])
        all_records.clear()
